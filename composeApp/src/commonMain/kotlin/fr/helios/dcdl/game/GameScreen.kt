        ...
        when {
            windowSizeClass.isWidthAtLeastBreakpoint(WindowSizeClass.WIDTH_DP_MEDIUM_LOWER_BOUND) -> {
                Row(modifier = Modifier.align(Alignment.CenterHorizontally)) {
                    ...
                    PlayerRoundComponent(gameUiState.currentRound, timer) { answer = it }
                }
            }
...
@Composable
fun PlayerRoundComponent(currentRound: GameRound?, timer: Long, setAnswer: (RoundAnswer) -> Unit) {
